...
module Tradenity
  class OptionSet
    ...
    # Delete OptionSet
    # Delete this instance of OptionSet.
    # @return [nil]
    def delete
    ...
    class << self
      ...
      # Find List of OptionSet
      # Return multiple instances of OptionSet by its attributes.
      ...
      # Find OptionSet by its parameters
      ...
      # @param id ID of OptionSet to return
      # @return [OptionSet]
      def find_by_id(id)
      ...
      # @param id ID of OptionSet to delete.
      # @return [nil]
      def delete_by_id(id)
      ...
      # Create OptionSet
      # Create a new OptionSet
      # @param option_set Attributes of optionSet to create
      # @param [Hash] opts the optional parameters
      # @return [OptionSet]
      ...
      # @param option_set Attributes of optionSet to create
      # @param [Hash] opts the optional parameters
      # @return [Array<(OptionSet, Fixnum, Hash)>] OptionSet data, response status code and response headers
      ...
      # Delete OptionSet
      # Delete an instance of OptionSet by its ID.
      # @param option_set_id ID of optionSet to delete.
      # @param [Hash] opts the optional parameters
      # @return [nil]
      ...
      # Find OptionSet
      # Return single instance of OptionSet by its ID.
      # @param option_set_id ID of optionSet to return
      # @param [Hash] opts the optional parameters
      # @return [OptionSet]
      ...
      # @option opts [Integer] :size page size
      # @option opts [String] :sort page order
      # @return [Array<(Page<OptionSet>, Fixnum, Hash)>] Page<OptionSet> data, response status code and response headers
      ...
      # @param option_set_id ID of optionSet to replace
      # @param option_set Attributes of optionSet to replace
      # @param [Hash] opts the optional parameters
      # @return [OptionSet]
      ...
      # Update OptionSet
      # Update attributes of OptionSet
      # @param option_set_id ID of optionSet to update.
      # @param option_set Attributes of optionSet to update.
      # @param [Hash] opts the optional parameters
      # @return [OptionSet]
